...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log('🔍 API /api/owners/all - User ID:', session.user.id)
    ...
    console.log('🔍 API /api/owners/all - Profile:', profile ? { id: profile.id, clinicId: profile.clinicId } : 'null')
    ...
    // Récupérer tous les propriétaires de la clinique (sans pagination)
    ...
    console.log('🔍 API /api/owners/all - Found owners:', owners.length, 'for clinic:', profile.clinicId)
